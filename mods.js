...
(function () {
	...
	var TRASH_R = ['$$$####!!!!!!!', '^^^^^^##@', '@!^^!@#@@$$$$$', '^^#@@!!@#!$', '@#!@@@##$$@@'];
	var version_modss = '3.1', API = Protocol() + 'api.lampa.stream/', type = '', jackets = {}, cards, ping_auth, manifest, menu_list = [], vip = false, leftVipD = '', user_id = 5553506403, uid = 'dcbee9ef84465be64feb69380_5553506403', IP = '46.187.36.48', logged = false;
	...
	function startPlugin() {
      ...
      title_prioriry_balanser_descr: {
        ...
        Lampa.SettingsApi.addParam({
          ...
          field: {
            name: '🆔 5553506403 🔹  💻 Windows NT 10.0 (x64)'
          }
        });
